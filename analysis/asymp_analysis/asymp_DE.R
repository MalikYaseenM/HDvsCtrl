...
count_matrix <- '../../samples/Analysis_Results/asymp_raw_filter.csv'
...
colData$Subject.subject_type <- ifelse(grepl("BA9",colData$Dataset.dataset_id),"BA9","CAP")
...
dds$Subject.subject_type <- relevel(dds$Subject.subject_type, ref='BA9')
